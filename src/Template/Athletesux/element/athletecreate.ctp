...
<div id="shader_modal">
    ...
    <div id="add_modal">
        ...
        /*echo $this->Form->control('_Token[fields]', ['type' => 'hidden', 'value' => $this->request->getParam('_csrfToken')]);
        echo $this->Form->control('_Token[unlocked]', ['type' => 'hidden', 'value' => ""]);        
        echo $this->Form->control('_Token[debug]', ['type' => 'hidden', 'value' => "d2b40og54te8rhv6pmt72gnjjo"]);     */   
        
        echo $this->Form->secure();
